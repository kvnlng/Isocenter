...
No test here skips without an optional codec, so every one runs wherever
the file is selected and in the release matrix: pydicom decodes RLE with no plugin at
