...
**Planning has moved to GitHub Issues.** This file is kept as a pointer;
it is no longer maintained as a plan.

Tracking work in the issue tracker rather than in a markdown file means
the roadmap can be filtered, assigned, cross-referenced, and closed by
the pull requests that implement it — none of which a checklist in a
file can do.
...
Shipped features are recorded in [`CHANGELOG.md`](CHANGELOG.md), which
