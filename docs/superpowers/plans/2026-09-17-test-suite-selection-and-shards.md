...
13. **Filed separately, not fixed here:** `SqliteStore` keeps a relative sidecar path and reopens it against the current cwd on every write. The review of #720 found it, and it is a library defect in its own right.
