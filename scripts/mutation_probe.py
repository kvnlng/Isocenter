...
TARGETS = {
    ...
    "isocenter/builders.py": (["tests/test_entities.py", "tests/test_export_contract.py", "tests/test_an_empty_patient_id_is_still_a_patient.py", "tests/test_an_id_less_subjects_dates_are_shifted.py",
    ...
    "isocenter/configuration.py": (["tests/test_an_export_says_how_it_was_de_identified.py", "tests/test_a_config_value_means_one_thing.py", "tests/test_a_saved_config_names_its_profile.py", "tests/test_auto_save_is_opt_in.py", "tests/test_automation.py",
                                    "tests/test_a_status_records_the_policy_it_was_scanned_under.py",
    ...
    "isocenter/reversibility.py": (["tests/test_an_edit_below_or_beside_an_instance_is_seen.py", "tests/test_a_token_says_how_it_was_written.py", "tests/test_recovery_returns_the_identity.py","tests/test_a_token_this_store_did_not_write_is_not_replaced.py",
                                    "tests/test_a_lock_under_the_wrong_key_refuses.py",
                                    "tests/test_recovery_needs_the_key_it_was_locked_with.py",
    ...
    "isocenter/privacy.py": (["tests/test_an_owner_stamped_copy_follows_its_owner.py", "tests/test_safe_export.py", "tests/test_a_restore_reads_the_token_it_was_given.py", "tests/test_a_restored_study_date_reaches_the_file.py", "tests/test_one_token_per_value_set.py", "tests/test_patients_sharing_an_id_are_merged.py", "tests/test_reingest_after_anonymize_keeps_studies.py", "tests/test_uids_are_replaced_by_the_project_secret.py", "tests/test_a_redacted_uid_is_derived_not_drawn.py", "tests/test_ingest_finds_what_anonymize_renamed.py", "tests/test_repeating_group_rules.py", "tests/test_the_d_codes_write_a_dummy.py", "tests/test_a_config_value_means_one_thing.py", "tests/test_one_loader_reads_a_config.py", "tests/test_a_token_this_store_did_not_write_is_not_replaced.py", "tests/test_the_grade_counts_findings_not_acted_on.py", "tests/test_subjects_without_a_patient_id_are_kept_apart.py", "tests/test_a_missing_study_or_series_uid_is_not_shared.py", "tests/test_an_id_less_subjects_dates_are_shifted.py",
                              "tests/test_a_status_records_the_policy_it_was_scanned_under.py",
                              ...
                              "tests/test_a_descriptor_edit_reads_the_same_across_a_save.py"], 30),
    "isocenter/remediation.py": (["tests/test_an_edit_below_or_beside_an_instance_is_seen.py", "tests/test_an_owner_field_edit_is_tracked.py", "tests/test_an_export_says_how_it_was_de_identified.py", "tests/test_uids_are_replaced_by_the_project_secret.py", "tests/test_floor_policy.py", "tests/test_the_grade_counts_findings_not_acted_on.py", "tests/test_an_owner_stamped_copy_follows_its_owner.py", "tests/test_audit_suppression.py", "tests/test_subjects_without_a_patient_id_are_kept_apart.py", "tests/test_a_missing_study_or_series_uid_is_not_shared.py", "tests/test_an_id_less_subjects_dates_are_shifted.py",
                                  "tests/test_a_status_records_the_policy_it_was_scanned_under.py",
                                  "tests/test_anonymize_records_what_it_left.py",
                                  "tests/test_a_partial_findings_list_is_not_remediated.py",
                                  "tests/test_a_replace_rule_writes_its_value.py",
                                  ...
                                  "tests/test_a_remove_on_an_owner_attribute_already_gone_is_satisfied.py",
                                  "tests/test_a_descriptor_edit_reads_the_same_across_a_save.py"], 30),
    "isocenter/io_handlers.py": (["tests/test_a_j2k_file_pillow_cannot_read_is_noted.py", "tests/test_an_export_says_how_it_was_de_identified.py", "tests/test_uids_are_replaced_by_the_project_secret.py", "tests/test_ingest_finds_what_anonymize_renamed.py", "tests/test_every_door_selects_patients_one_way.py", "tests/test_an_unmatched_patient_id_is_counted.py", "tests/test_a_file_backed_instance_reads_as_its_descriptors_declare.py", "tests/test_subjects_without_a_patient_id_are_kept_apart.py", "tests/test_a_missing_study_or_series_uid_is_not_shared.py", "tests/test_an_id_less_subjects_dates_are_shifted.py",
    ...
    "isocenter/persistence.py": (["tests/test_a_redacted_uid_is_derived_not_drawn.py", "tests/test_ingest_finds_what_anonymize_renamed.py", "tests/test_every_door_selects_patients_one_way.py", "tests/test_an_unmatched_patient_id_is_counted.py", "tests/test_a_project_secret_stays_in_its_store.py", "tests/test_a_kept_private_binary_value_keeps_its_vr.py", "tests/test_an_id_less_subjects_dates_are_shifted.py",
    ...
    # budget.
    "isocenter/session.py": (["tests/test_an_edit_below_or_beside_an_instance_is_seen.py", "tests/test_an_owner_field_edit_is_tracked.py", "tests/test_a_j2k_file_pillow_cannot_read_is_noted.py", "tests/test_an_export_says_how_it_was_de_identified.py", "tests/test_a_token_says_how_it_was_written.py", "tests/test_uids_are_replaced_by_the_project_secret.py", "tests/test_a_redacted_uid_is_derived_not_drawn.py", "tests/test_ingest_finds_what_anonymize_renamed.py", "tests/test_an_owner_stamped_copy_follows_its_owner.py", "tests/test_every_door_selects_patients_one_way.py", "tests/test_an_unmatched_patient_id_is_counted.py", "tests/test_repeating_group_rules.py", "tests/test_the_d_codes_write_a_dummy.py", "tests/test_a_project_secret_stays_in_its_store.py", "tests/test_a_config_value_means_one_thing.py", "tests/test_a_saved_config_names_its_profile.py", "tests/test_auto_save_is_opt_in.py", "tests/test_one_loader_reads_a_config.py", "tests/test_a_file_backed_instance_reads_as_its_descriptors_declare.py", "tests/test_subjects_without_a_patient_id_are_kept_apart.py", "tests/test_a_missing_study_or_series_uid_is_not_shared.py", "tests/test_an_id_less_subjects_dates_are_shifted.py",
                              "tests/test_a_kept_private_binary_value_keeps_its_vr.py",
                              "tests/test_a_nested_item_status_survives_a_reopen.py",
                              "tests/test_a_pre_1_0_store_keeps_its_statuses_without_a_policy.py",
                              "tests/test_a_reopened_store_keeps_the_text_of_ds_and_is.py",
                              ...
                              "tests/test_wfdb_start_date_honesty.py",
                              "tests/test_wfdb_writer.py",
                              "tests/test_withheld_instances_are_audited.py", "tests/test_the_grade_counts_findings_not_acted_on.py",
                              "tests/test_worker_loss_is_reported.py",
                              "tests/test_ybr_jpegls_read_doors.py",
                              "tests/test_ybr_read_door_labels.py",
                              "tests/test_a_pre_097_store_keeps_one_offset_per_patient.py",
    ...
    "isocenter/entities.py": (["tests/test_an_edit_below_or_beside_an_instance_is_seen.py", "tests/test_an_owner_field_edit_is_tracked.py", "tests/test_a_j2k_file_pillow_cannot_read_is_noted.py", "tests/test_an_export_says_how_it_was_de_identified.py", "tests/test_withheld_instances_are_audited.py", "tests/test_uids_are_replaced_by_the_project_secret.py", "tests/test_a_redacted_uid_is_derived_not_drawn.py", "tests/test_ingest_finds_what_anonymize_renamed.py", "tests/test_an_owner_stamped_copy_follows_its_owner.py", "tests/test_every_door_selects_patients_one_way.py", "tests/test_the_d_codes_write_a_dummy.py", "tests/test_a_project_secret_stays_in_its_store.py", "tests/test_a_config_value_means_one_thing.py", "tests/test_one_loader_reads_a_config.py", "tests/test_a_file_backed_instance_reads_as_its_descriptors_declare.py", "tests/test_subjects_without_a_patient_id_are_kept_apart.py", "tests/test_a_missing_study_or_series_uid_is_not_shared.py", "tests/test_an_id_less_subjects_dates_are_shifted.py",
                               "tests/test_a_kept_private_binary_value_keeps_its_vr.py",
                               "tests/test_a_nested_item_status_survives_a_reopen.py",
                               "tests/test_a_pre_1_0_store_keeps_its_statuses_without_a_policy.py",
                               "tests/test_a_status_records_the_policy_it_was_scanned_under.py",
